...
class ShapeNet(data.Dataset):
    ...
    def _load_data(self):
        ...
        for line in lines:
            ...
            if self.split == 'train':
                partial_paths.append(os.path.join(self.dataroot, self.split, 'partial', category, model_id + '_{}.ply'.format(random.randint(0,7))))
            else:
        ...
        #print(os.path.join(self.dataroot, self.split, 'partial', category, model_id + '_{}.ply'.format(random.randint(0,7)))) 
